...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','videohya.adwhirlvpon.js')
	...
	f = os.path.join(cwd,'Classes','VideohyaAdwhirlvponModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','videohya.adwhirlvpon.js']
