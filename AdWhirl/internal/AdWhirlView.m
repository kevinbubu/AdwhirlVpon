...
- (void)adRequestReturnsForAdapter:(AdWhirlAdNetworkAdapter *)adapter {
  ...
  // dict
  NSNumber *netTypeKey = [NSNumber numberWithInt:(int)adapter.networkConfig.networkType];
  AdWhirlAdNetworkAdapter *pendingAdapter = [pendingAdapters objectForKey:netTypeKey];
